...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            ...
                            <p>Welcome to DeepSeek AI! Start a conversation and explore the amazing capabilities of artificial intelligence. DeepSeek is here to assist you with insightful responses to any question you may have.</p>
                            ...
                            <p>Feel free to ask anything, from simple queries to complex topics, and see how DeepSeek AI handles it. The more you chat, the better it understands and adapts to your needs!</p>
                            <p>Ready to dive into the world of AI? Start typing below to begin your conversation with DeepSeek AI!</p>
                            <p>Made by <a href="https://t.me/botnations" target="_blank">Swastik</a> | Powered by DeepSeek AI</p>
                        </div>`;
...
const showTypingAnimation = () => {
    const html = `<div class="chat-content">
                    <div class="chat-details">
                        <img src="images/DeepSeek.png" alt="deepseek-img">
